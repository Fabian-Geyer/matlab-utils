...
table[x=eta, y=phi]{\data/trimanalysis/cumulus/6dof.dat};
...
table[x=eta, y=phi]{\data/trimanalysis/cumulus/6dof/limitcycles.dat};
...
\node[coordinate] (anchor) at (-5, -72.5) {};

\node[coordinate] (magn min) at (-27, -4) {};
\node[coordinate] (magn max) at (-21, 6) {};
