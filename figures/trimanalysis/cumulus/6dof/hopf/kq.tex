...
xmajorgrids,
ymajorgrids,
y filter/.expression={\thisrow{q} > 0.155 ? nan : y + 1.9},
...
table[x=eta, y=kq]{\data/trimanalysis/cumulus/6dof/K0.dat};
...
table[x=eta, y=kq]{\data/trimanalysis/cumulus/6dof/hopf/kq.dat};
\addlegendpair[trimHopf1]{$k_q$};
