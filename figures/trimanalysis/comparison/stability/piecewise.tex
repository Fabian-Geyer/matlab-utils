...
\addlegendpair[coeffPW, black, solid]{stable trim}

\addlegendpair{$\quad$}

\addlegendpair[coeffPW, black, loosely dashed]{unstable trim}
...
%% piecewise fit
\addplot[trimSurface, coeffPW, loosely dashed,
	x filter/.expression={\thisrow{ustab} != 1 || \thisrow{eta} > 0 ? nan : x},
	] 
	table[x=V, y=alpha]{\data/trimanalysis/piecewise.dat};
