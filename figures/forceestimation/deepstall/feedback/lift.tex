...
colorbar style={ylabel={lift coefficient ($\cdot$)}},
% save color bar to name
colorbar to name=colorbar-forceestimation-feedback-lift,
]
% add 3D plot
...
table[x=alpha, y=q, z=eta, meta=Clift]{\data/forceestimation/cumulus/feedback.dat};
