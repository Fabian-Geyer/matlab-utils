...
point meta max=200,
colormap/jet,
legend to name=legend-stableset-control3-elevator,
]
\addplot3[contour gnuplot, safeSetElps,
mesh/rows=100, mesh/cols=100,
]
table[x=eta,y=alpha,z=P]{\data/safeset/stableset/cumulus/control3/elevator.dat};
...
table[x=eta,y=alpha,z=Lya-1]{\data/safeset/stableset/cumulus/control3/elevator.dat};

\addplot3[contour gnuplot, safePW, dashdotdotted,
z filter/.expression={y < 16.2949 ? nan : z},
mesh/rows=100, mesh/cols=100,
]
table[x=eta,y=alpha,z=Lya-2]{\data/safeset/stableset/cumulus/control3/elevator.dat};
...
table[x=eta,y=alpha,z=k]{\data/safeset/stableset/cumulus/control3/elevator.dat};
